...
class UI: #UI class, contains  every prints in this program
    ...
    def menu(self):
        ...
        while True:
            while True:
                ...
                try:
                    opt=input()
                    assert opt=="1" or opt=="2" or opt=="3" or opt=="0" or opt=="4" or opt=="5" or opt=="Undo" or opt=="Redo" or opt=="6" or opt=="7"
                    break
                except:
                    print("Bad command!")
            if opt=="0":
    ...
    def filter_object(self):
        lst=self.service.filter_objects()
        for i in lst:
            print(i)
